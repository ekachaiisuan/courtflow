...
- components/: reusable UI (components/ui/_) และ feature components (components/forms/_, components/email/\*)
...
- หากมี schema changes ให้รัน migrations ในเครื่อง และตรวจสอบหน้าหรือ API routes ที่ได้รับผลกระทบ
  **หากเพิ่ม tests**:
- วางไฟล์ไว้ใกล้ feature นั้น ๆ (\*.test.ts[x]) หรือในโฟลเดอร์ **tests**/
